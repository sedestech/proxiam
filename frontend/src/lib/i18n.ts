  ...
  fr: {
    translation: {
      ...
      billing: {
        ...
        subtitle: "Gérez votre plan, vos clés API et la collaboration",
        plans: "Plans",
        free: "Gratuit",
      ...
      predictions: {
        ...
        subtitle: "Analyse prédictive et benchmark marché",
        selectProject: "Sélectionner un projet",
        enterProjectId: "ID du projet",
        analyze: "Analyser",
        successProbability: "Probabilité de succès",
        confidence: "Confiance",
        factors: "Facteurs d'analyse",
        ...
        metric: "Métrique",
        projectValue: "Valeur projet",
        marketAvg: "Moyenne marché",
        status: "Statut",
        above: "Au-dessus",
        below: "En dessous",
        inline: "Dans la moyenne",
        noProject: "Entrez un ID de projet pour voir les prédictions",
      },
      monitoring: {
        title: "Monitoring",
        subtitle: "Santé du système et métriques",
        ...
        gitSha: "Commit Git",
        metrics: "Métriques",
        requestCount: "Requêtes totales",
        avgResponseTime: "Temps de réponse moyen",
        autoRefresh: "Rafraîchissement automatique (30s)",
      },
      deleteConfirm: {
  ...
  en: {
    translation: {
      ...
      billing: {
        ...
        subtitle: "Manage your plan, API keys, and collaboration",
        plans: "Plans",
        free: "Free",
      ...
      predictions: {
        ...
        subtitle: "Predictive analysis and market benchmark",
        selectProject: "Select a project",
        enterProjectId: "Project ID",
        analyze: "Analyze",
        ...
        below: "Below",
        inline: "Inline",
        noProject: "Enter a project ID to see predictions",
      },
      monitoring: {
        title: "Monitoring",
